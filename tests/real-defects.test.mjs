 ...
 *
 * Every case below shipped to production in a codebase with 4,408 passing tests, a linter, a type
...
test("bug 1: a base rule's SHORTHAND erases a modifier's longhand, 379 lines later", () => {
